...
const NTCARequestHeader: React.FC = () => {
    ...
    return (
        <header className="relative z-20 flex items-center justify-between px-6 py-4 border-b border-sky-500/20 bg-black">
            <button
                id="ntca-request-back-button"
                onClick={() => navigate('/efas-v1/portal')}
                className="flex items-center gap-2 text-white hover:text-sky-300 px-3 py-2 rounded-xl hover:bg-neutral-800 border border-neutral-700 hover:border-sky-500/40 transition-all duration-200 text-sm font-medium"
            >
            ...
            <div className="absolute left-1/2 -translate-x-1/2 text-center pointer-events-none select-none">
                <p className="text-sky-400/70 text-[10px] tracking-widest uppercase">
                    AFD-FM-MNT-001
                </p>
